...
class Employee(AbstractUser):
    ...
    paychex_flex_workerID = models.CharField(null=True, max_length=256, verbose_name="Paychex WorkerID", blank=True, help_text="Unique identifier generated by PayChex for this employee. Can be auto-filled via PayChex API or manually entered. Paychex API will NOT overwrite this value once entered")
