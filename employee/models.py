...
class Employee(AbstractUser):
    ...
    id_barcode = models.CharField(max_length=32, verbose_name="ID Card Barcode", blank=True, null=True, help_text="The numbers on the bottom left of the BACK of your BU ID; found underneath the barcode. Enter all numbers WITHOUT spaces. Do not enter the numbers under the right hand side of the barcode.")
...
class Paperwork(models.Model):
    ...
    assign_to_all_new_employees = models.BooleanField(default=False)
